...
//var baseLoginURL = document.location.origin + "/";
var baseLoginURL = '/';
//var baseLoginURL = 'http://192.168.1.123:8093/';
//var baseLoginURL = 'http://localhost:2865/';
; (function ($, window, undefined) {
    "use strict";

    $(document).ready(function () {
        neonLogin.$container = $("#form_login_organiser");
        ...
        neonLogin.$container.validate({
            ...
            submitHandler: function (ev) {
                /*
                We are holding user and pass on submit as chrome resting and autofilling the password field during settimeout.
                */
                var user = $(ev).find("#username").val();
                var pass = $(ev).find("#password").val();
                /* 
					Updated on v1.1.4
				...
				*/
                ...
                setTimeout(function () {
                    ...
                    $.ajax({
                        url: baseLoginURL + 'Organiser/Home/CheckLogin',
                        cache: false,
                        method: 'POST',
                        dataType: 'json',
                        data: {
                        ...
                        success: function (response) {
                            ...
                            setTimeout(function () {
                                ...
                                if (login_status == 'invalid' || login_status == 'inactive') {
                                    $("#errorMessage").html('');
